...
class ResEquipementCommand extends Command
{
    /**
    ...
    {
        $this
            ->setName('meet:res-equipement')
            ->setDescription('Mise à jour des équipements de terrains de sports');
    }
...
//        }
        ...
        if (($handle = fopen("/var/www/tennis/res/20180110_RES_FichesEquipements.csv", "r")) !== FALSE) {
